...
class TransactionSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        try:
            user_accounts = UserAccount.objects.get(id=user_id)  
        ...
        try:
            ...
            with transaction.atomic():
                ...
                post_body = {
                    ...
                    'success_url': 'https://library-management-server-tp1n.vercel.app/transaction/success/', 
                    'fail_url': 'https://library-management-server-tp1n.vercel.app/transaction/fail/',
                    'cancel_url': 'https://library-management-server-tp1n.vercel.app/transaction/cancel/',
                    'emi_option': 0,
